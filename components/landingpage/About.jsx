        ...
        <div className={styles.topContent}>
          ...
          <div>
            <p>
              ...
              tradition, flavour, and hospitality. Inspired by the rich culinary
              heritage of coastal Andhra, we serve dishes prepared with fresh
              ingredients, bold spices, and time-honoured recipes.
            </p>
            <p>
              From aromatic biryanis to Konaseema-style curries, every plate is
              crafted to create comfort, celebration, and connection. Whether
              you're dining with family or hosting a special gathering, PJ Resto
              Café is where great food becomes great memories.
            </p>
          </div>
        </div>
